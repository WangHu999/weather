...
public interface ApiService {
     ...
     * @return
     */
    @GET("/s6/weather/now?key=6d8416ad6f544eb2866e56f869f3aee4")
     ...
     * 未来3 - 7天天气预报
     */
    @GET("/s6/weather/forecast?key=6d8416ad6f544eb2866e56f869f3aee4")
    Call<WeatherForecastResponse> getWeatherForecast(@Query("location") String location);
    /**
     * 生活指数
     */
    @GET("/s6/weather/lifestyle?key=6d8416ad6f544eb2866e56f869f3aee4")
     ...
     * 逐个小时预报
     */
    @GET("/s6/weather/hourly?key=6d8416ad6f544eb2866e56f869f3aee4")
    Call<HourlyResponse> getHourly(@Query("location") String location);

    /**
     * 空气质量数据
     */
      @GET("/s6/air/now?key=6d8416ad6f544eb2866e56f869f3aee4")
